...
if __name__ == "__main__":
    ...
    for test_batch in tqdm(test_pairs):
        ...
        tmp_predict = {}
        tmp_predict["predicts"] = test_res
        tmp_predict["logic"] = [d.cpu().item() for d in logic_out]
        predicts_inter.append(tmp_predict)
    ...
    print("------------------------------------------------------")
    write_json('predicts_inter.json', predicts_inter)
    write_json('our_val_acc.json', our_val_acc)
