...
if __name__ == "__main__":
    ...
    for epoch in range(args.n_epochs):
        ...
        if (epoch+1) % valid_epoch == 0 or epoch > args.n_epochs-5:
            ...
            print("valid_acc", float(equation_ac) / eval_total, float(value_ac) / eval_total)
            ...
            if not args.save:
                ...
                print("best_test_acc", best_equ_ac_test, best_val_ac_test)
                ...
                with open(logfile, 'a') as file_object:
                    ...
                    file_object.write("best_test_acc:  %f %f \n"% (best_equ_ac_test, best_val_ac_test))
